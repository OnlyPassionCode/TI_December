...
<body>
    ...
    <main>
        <h2>Histoire</h2>
        <div id="imagepresentation"><img src="img/histoire.jpg" alt="Image historique de la Finlande"></div>
        <div>
